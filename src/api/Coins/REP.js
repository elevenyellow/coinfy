...
export const symbol = 'REP'
export const name = 'Augur'
export const color = '#5E2851'
export const contract_address = '0xe94327d07fc17907b4db788e5adf2ed424addff6'
export const labels = 'rpe agur ethereum token erc20 ecr20'
