...
export const symbol = 'GNT'
export const name = 'Golem'
export const color = '#032F62'
export const contract_address = '0xa74476443119A942dE498590Fe1f2454d7D4aC0d'
export const labels = 'gtn ethereum token erc20 ecr20'
