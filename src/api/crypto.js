...
// from https://github.com/cryptocoinjs/scryptsy changed import 'crypto' for import 'pbkdf2' to make a smaller bundle
var MAX_VALUE = 0x7fffffff
// N = Cpu cost, r = Memory cost, p = parallelization cost
export function scrypt(key, salt, N, r, p, dkLen, progressCallback) {
    if (N === 0 || (N & (N - 1)) !== 0)
