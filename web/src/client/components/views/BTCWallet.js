...
function BTCWalletTemplate({ pathname }) {
    return (
        <div>
            <RightHeader>
                <RightHeaderInner>
            ...
            <RightContent>
                <RightContentMenu>
                    ...
                    <RightContentMenuItem disabled={true}>
                        <RightContentMenuItemIcon transform="rotate(-45deg) translateX(3px) translateY(-1px)"><IconReceive size={23} color={styles.color.disabled2} /></RightContentMenuItemIcon>
                        <RightContentMenuItemText>Send <Tooltip>Set your private first.</Tooltip></RightContentMenuItemText>
                    </RightContentMenuItem>

                    <RightContentMenuItem>
                        <RightContentMenuItemIcon><IconPrint size={23} color={styles.color.front2} /></RightContentMenuItemIcon>
