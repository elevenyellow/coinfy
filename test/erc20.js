...
import { setupNetwork as setupNetwork2 } from '/api/coins/ETH'
...
test('setupNetwork', t => {
    ...
    t.equal(setupNetwork2(MAINNET, networks), true, 'setupNetwork2')
    t.end()
})
...
test('createSimpleTx', t => {
    ...
    setupNetwork2(TESTNET, networks) // changing to testnet
...
test('getSendProviders', t => {
    setupNetwork(MAINNET, networks) // changing to mainnet
    setupNetwork2(MAINNET, networks) // changing to mainnet
